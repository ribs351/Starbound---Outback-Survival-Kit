...
function self.weapon:setStance(stance)
	...
	--moved your dumb flip thing here and made it less shit
	animator.setFlipped(stance.flipx == true)
	
	
	local air = not mcontroller.groundMovement()
	local velocity = air and stance.airVelocity or stance.velocity
